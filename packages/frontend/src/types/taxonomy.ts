...
export const TAXONOMY_TYPES: TaxonomyTypeInfo[] = [
  ...
  { type: 'institution', label: 'Institutions', description: 'Educational and research institutions' },
  ...
  { type: 'activities_of_interest', label: 'Activities of Interest', description: 'Areas of activity' },
  { type: 'applications_and_technologies', label: 'Applications & Technologies', description: 'Application domains' },
  { type: 'cluster_thematic_area', label: 'Thematic Areas', description: 'Cluster focus areas' },
  { type: 'cybersecurity_research_projects', label: 'Research Projects', description: 'Cybersecurity research' },
  { type: 'european_cybersecurity_competenc', label: 'EU Competencies', description: 'European competencies' },
